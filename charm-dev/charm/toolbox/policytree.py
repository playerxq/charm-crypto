...
class PolicyParser:
    ...
    def getBNF(self):
        ...
        OperatorOR = Literal("OR").setParseAction(pyparsing_common.downcaseTokens) | Literal("or")
        OperatorAND = Literal("AND").setParseAction(pyparsing_common.downcaseTokens) | Literal("and")
